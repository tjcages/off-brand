...
const _ = () => {
  ...
  return (
    <e.group theatreKey="workbench-content" position={[0, 2, -8]}>
      ...
      <e.group theatreKey="workbench-content/view" visible={views.includes("background")}>
        <Image
          ref={ref}
      ...
      <e.group
        theatreKey="workbench-content/ui"
        visible={views.includes("foreground")}
        position={[0, -0.5, 0.5]}
      >
        <Image
          ref={uiRef}
          url={"/textures/stripe/workbench/overview.png"}
          // @ts-expect-error –no alt prop
          alt="workbench"
          transparent
          side={THREE.DoubleSide}
        ...
        >
          {/* @ts-expect-error –yes it does exist... */}
          <bentPlaneGeometry args={[0.1, 3.5, 1.715, 15, 15]} />
        </Image>
      </e.group>
