  ...
  return (
    <group ref={ref} renderOrder={10}>
      ...
      >
        <div
          className={cn(
            "relative flex flex-col items-start justify-start gap-2 w-full max-w-sm px-4 pt-2 pb-2.5 text-[20px] text-center text-white bg-black/80 border border-white/10 outline outline-2 rounded-lg backdrop-blur-md overflow-hidden pointer-events-none transition-all duration-300 ease-out",
            visible
