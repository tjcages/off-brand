...
const _ = () => {
  ...
  return (
    <div className="fixed left-0 right-0 top-0 flex items-center justify-between w-full gap-8 px-4 md:px-8 py-3 md:py-6">
      ...
      <button
        className={cn(
          "text-[15px] md:text-[16px] px-3 md:px-4 py-1.5 md:py-2 text-white outline-[1px] md:outline-2 bg-transparent border border-white/50 opacity-0 transition-all duration-200 ease-out hover:text-black hover:outline-offset-[4px]",
